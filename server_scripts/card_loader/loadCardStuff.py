...
class CardLoader:
    # TODO: write description for what this class does

    __slots__ = ('rootdir', # string
                 'cardpath', #string
                 )
    ...
    def __init__(self,
        ...
        self.cardpath = f'{rootdir}/cards.txt'

    def loadCards(self):
        with open(self.cardpath) as f:
            return json.loads(f.read())

    def saveCards(self, cards):
        with open(self.cardpath, 'w') as f:
